...
contract CapitalizeTheTitle_2129 {
    ...
    function capitalizeTitle(string memory input) public pure returns (string memory) {
        ...
        for (uint256 i = 0; i < length; i++) {
            ...
            if (char == 32) {
                ...
                if (isWordStart) {
                    ...
                    if (i + 2 < length && uint8(inputBytes[i + 1]) != 32 && uint8(inputBytes[i + 2]) != 32) {
